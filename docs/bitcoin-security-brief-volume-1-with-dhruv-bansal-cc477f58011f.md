...
如果你决定自己生成你的私钥，你应该使用一些技术来估计你的种子中“有多少随机性”,就像检查你决定使用的熵源一样。
...
**为了跟上比特币安全的最佳实践，你推荐人们追随哪些比特币创造者？**
