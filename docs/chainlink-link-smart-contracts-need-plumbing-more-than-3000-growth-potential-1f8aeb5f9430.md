# ChainLink:智能合约需要“管道”，超过 3000%的增长潜力
...
![](img/099ff0d437849a037325e9718178485e.png)
...
作为一项 oracle 服务，Chainlink 节点返回由用户契约(称为请求契约)或代表用户契约发出的数据请求和查询的回复。
...
Chainlink 未来将使用的另一种方法是可信硬件，以进一步推进其分散化方法。
