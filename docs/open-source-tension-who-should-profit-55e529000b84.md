...
开源提供商正在努力寻找他们的商业模式，作为该技术的生产者或作为该技术的赞助商，所以这就是紧张的来源，所以这有点像这些开源公司或这些项目的赞助商有很大的压力，就像“我们如何赚钱？”这种感觉有点——我想这是一种被认为理所当然或被利用的感觉。
...
乔恩:是的。在节目的这一点上，如果我们是一个无线电实验室，将会有一个 DJ scratch，我们会说，“等一下，”因为我认为我们接下来要去的地方是说所有这些开源赞助的公司，如 Mongo，如 Redis，他们没有自己的产品在典型的意义上。他们可能会更改这些产品的未来版本的许可证，但他们只能这样做，因为这些许可证从一开始就是开源的，所以他们只是拿了一个版本，然后说，“嘿，我们将基于这个版本为不同的许可证创建一个商业产品，”在一些免费可用的公共领域中。

对我来说这很有趣。这些公司——我认为在这次谈话中，对我来说，核心的认知不和谐是，“嗯，Mongo 正在改变他们的许可证，”或者，“Redis 正在改变他们的许可证，”我认为我们需要把这两者分开，并说，“不，这不是他们的代码。这是开源代码。它不属于 Redis 实验室，Mongo 也不属于 MongoDB，”当他们更改许可证时，他们只是说，“我们将采用我们内部一直在开发的版本，并在其上添加新的许可证，”他们完全欢迎这样做。

以前的开源许可允许这样做，所以我认为这是给我这个啊哈时刻的原因，就像“哇。”好吧，仅仅因为他们围绕开源产品建立了业务并不意味着他们就是开源产品，这只是让我有点喜欢——我甚至不。我只是摇摇头，“哇，这太奇怪了。现在会发生什么？”所以我想我们会稍微讨论一下。

在我们深入探讨他们真正的权利以及他们对这些开源项目的贡献应该得到什么之前，让我们先谈一谈谁是开源的消费者。你想再经历一次吗，克里斯？

克里斯:太好了。显然，这里的大大猩猩是 AWS。AWS 有许多不同的开源项目，这些项目被转化为高度可用、高度可扩展的服务，这些服务被完全管理，因此非常易于使用。雷迪斯就是很好的例子，Memcached，卡夫卡。我们谈到了 DocumentDB，它是 MongoDB 的降代。你有弹性搜索。这样的例子不胜枚举。AWS 已经将相当多的开源软件转化为服务。

对此不要有任何误解。他们添加了许多令人难以置信的专业知识、工程设计和大量资源，来提供这些高度可用、高度可扩展的托管服务，这似乎是竞争的核心症结所在，也是为什么 Redis Labs 和 Mongo 等公司会遇到问题的原因，这是——我们在开始时对此略有涉及，只是说，“嘿， 形势正在发生变化，今天与五年前相比已经有所不同，”发生的一个巨大变化是，云已经出现，云原生开发已经出现，人们正在云中运行。

以前，不是这样。你去了，基本上，一切都是本地的，你自己安装软件，你管理它，你应用更新和补丁，这对开源社区来说非常非常好，因为你的商业模式就像是，“我们可以收取支持费用”，所以把软件送出去，但人们将需要支持如何集成，如何运行它，如何管理它，如何进行备份和恢复，等等，所以我们将提供支持合同。这是我们的商业模式。

它真的很好，但是，当其他公司现在开始提供该产品作为服务时，你就不再需要它了，所以美元转换了，它们以不同的方式流动，这就是现在整个争论的焦点。这些开源提供商就像这样，“过去对我们有效的商业模式现在不起作用了。我们真的很难与那些知道如何运行 SaaS 软件的云公司竞争。”

乔恩:这是我在这次谈话开始时就在想的事情，我觉得现在说出来不太合适，现在，我认为是说的时候了。这是一种简化的说法，有些人可能会就此指责我，但我们在软件行业已经有很长一段时间了，感觉好像如果你的市场是软件开发商或者是创建和运行软件的人，如果那是你的市场-所以，在软件行业的内部人士中-感觉公司有两个难题。

一个难题是让开发者购买/使用你的软件。“我在一个新的数据库里。嘿，各位，用我的新数据库。很酷。这是最好的。真的，真的，真的。”这是一个非常非常困难的问题。对开发者的营销就像——哦，我的上帝，我们现在正在做的是播客的一部分，但是你明白了，对吗？这是一个难题。

另一个难题是大规模软件运营，这个问题已经有了很大的改变。我认为几年前开发人员的市场营销发生了变化，现在，操作软件的规模也在变化，这就是我要说的。

开源解决了对开发者的营销问题，终于找到了一种让开发者不用打电话、发邮件、打扰他们就能使用产品的方法。相反，你只是使用这种完全游击式的营销方式，比如，“嘿，为这个开源项目做点贡献吧，”或者“使用这个免费的库。每个人都在用它。是的，我一直在用它。我在我的聚会上谈论它。太棒了。”

突然间，好的产品开始上升到顶端，并被越来越多的人使用，然后，当你有了一个真正的赢家，你知道它，这就是开源的一个特点，我会说。对吗？你会这么说吗，克里斯？

克里斯:我的意思是开源是关于社区的。这是一种拥有——它建立了与软件的关系，一种真正核心、基本的关系，因此购买软件和构建软件之间有着巨大的差异。如果你开发软件，你会对它有一种拥有感，而且你会对它更加忠诚，而不仅仅是购买现成的东西。那种关系不存在。

是的，当你和像开发人员这样的人交谈时，会有很多不必要的想法，比如，“我可以把这个东西做得更好。我可以把这个东西设计得更好。”开源把所有的东西都扔出窗外，开源是好的。你能让它变得更好？提交一份 PR。

乔恩:对。没错，所以它解决了非常奇怪的营销问题，然后像 Red Hat 这样的公司，像 Confluent 这样的公司，因为开源项目的最初创始人——我实际上不太清楚我刚才提到的那两家公司的创始故事，但通常情况下，由几个创始人开始的开源项目，他们意识到他们必须抓住你的尾巴。

他们意识到他们看到他们的 GitHub 星星在上升，上升，上升，他们就像，“哦，我的天哪。我们必须对此做点什么”，然后成立一家公司。这是一个非常好的方式，让人们意识到他们有动力获得潜在的风险投资资金，并围绕开源项目建立一些东西，是的，他们大部分确实创造了这些东西，但在他们真正走得很远之前，他们把它给了世界。这是我刚才用的一个很重要的短语。他们把它给了世界。他们真的以合法的方式为世界服务。

克里斯:是的，我的意思是这就是开源软件，对吗？一旦你决定开源，这就是合同。这是它的全部前提，这是给予社区的东西，它不属于任何人；它归社区所有，这种想法是，“嘿，如果你觉得这个软件有用，就使用它，如果你能帮助它变得更好，”这一切都是在它将会发展的承诺下，它将会从那个社区变得更好。

一旦你决定把它变成一个社区项目，这就是你所做的。你现在不能试图把它变成某种你可以从中赚钱的所有者的东西。

乔恩:这就是症结所在，因为这就是游戏。这是人们意识到他们可以做的事情，也是创造一个有价值的内部软件的途径。每个人都意识到，“我不能就这么去开一家公司，做一个新的花哨的数据库，”或者一些东西，或者一个 web 应用程序的花哨的管理系统，就像，“我不能作为一家公司去做那件事。我必须先获得一个受欢迎的开源项目，然后我才能说服人们我可以围绕它创建一家公司。”

这是对过去和平与热爱自由软件时代的背离。这真的很有战略性，就像，“我们制造这个东西，把它给世界，然后一旦世界决定他们喜欢它，我就要利用它，”这就有点紧张了。有个东西随着云一起落下来了。

克里斯:再一次，一切都变化得太快了，商业模式，只是玩家和有什么机会。我认为 Apache 项目是一个很好的例子。这种感觉有点像纯粹的游戏，就像这是核心社区项目，真的，这一切都是为了社区，分享，贡献和建设一些东西，一些真正伟大的东西。
...
克里斯:对，NPM 是个有趣的地方。它有自己独特的特点。NPM 从一开始，即使它是节点的包管理器，它是完全独立的。艾萨克·施鲁特，NPM 的创造者，实际上把它保留为自己的。我不知道具体许可是什么，但它完全不是节点项目的一部分。这实际上是艾萨克做的事情，所以他去创建了 NPM，基本上是为了在 NPM 做生意。
