...
*不幸的是，维护一个高完整性的时态地图被证明是极具挑战性的。随着地图的改善，社会的集体经济潜力增加，利用信任的短期价值也会增加。其他人越是努力创造连贯的社会价值，就越有可能享受这种价值的好处，而自己却不承担贡献的机会成本。这就是所谓的[搭便车问题](https://en.wikipedia.org/wiki/Free-rider_problem)，通常从集团经济效率低下或无力管理局部负外部性的角度来讨论。虽然这些框架仍然有效，但我认为这个问题的根源要深得多，并且似乎在时间本身的层面上得到最充分的概念化。*
...
*Benjamin Franklin’s favorite invention: the armonica. [Watch it](https://www.youtube.com/watch?v=eEKlRUvk9zc) sing.*
...
*Left: Consonant frequencies [generating “harmonicity” in the auditory cortex](http://www.pnas.org/content/109/48/19858). Right: Dissonant frequencies give rise to “inharmonic beating”.*
...
尽管民主和共和政体是一个巨大的进步，因为它们正式承认了去中心化的价值，但与我们今天观察到的社会技术复杂性的指数增长相比，它们仍然是相当集权的。事实上，有人可能会说它们是最集中的政治分权形式。我的意思是，虽然这种形式的治理以投票的形式实例化了自底向上信息流的正式机制，但它们是以保留高度正式编码的层次结构的方式进行的。人们只要注意到这样一个事实就可以证实这一点:地方治理结构通常被日益抽象的政治和经济组织领域所取代——每增加一个阶层都会减少有意义行动者的数量——最终形成一小部分集中节点，大部分政治、社会和经济资本通过这些节点流动。
...
*这在一定程度上解释了为什么互联网——与最初的乌托邦信念相反——似乎增加了普通用户经历的短期人际和群体间冲突的程度。毫无预警地，我们已经将人类的一个重要部分置于一个共享的现象学框架中，并且才刚刚开始观察紧急干扰的许多结果来源。正如托马斯·弗里德曼(Thomas Friedman)的著名观察，我们日益增长的技术连通性已经使世界变得扁平。然而，世界上的人们——以及他们各自的时间地图——仍然是高维度的，因此很难适应这个技术平原。*
...
*![](img/bde8cab693b51aaef00fc14fd1631e97.png)*
...
*对自上而下的力量的需求和突发一致性水平之间的这种反比关系意味着:*
...
**栖息在分散化技术的实验地平线上，许多声音唱和促进*无信任交互的概念。*正如歌曲所唱，通过在分散基础设施层面提供行为保证，我们可以在不直接信任交易对手或不依赖可信第三方的情况下与其他参与者进行交易。在我们概述的术语中，这种*不信任*的想法映射到交易和争议的解决，而不求助于使用*直接冲突*或*高级(即集中式)抽象层*。**
...
**那么，亲爱的读者，你是做什么的？理想的情况是——你的朋友自愿为你们共同的长期利益牺牲一只手——需要足够大的信任和诚信来抵制天真地选择短期确定性而不是长期可能性的理性策略(T4)。毕竟，从纯粹理性的角度来看，如[因果决策理论](https://plato.stanford.edu/entries/decision-causal/)，让你的朋友承受失去一只手的损失是没有意义的，因为你对星座信息的准确传达只是一种可能性，而不是确定性。相反，为了获得理想的结果，你必须自愿让你的个人理性屈从于高阶元理性，这种高阶元理性来自于*信任凝聚共享时间地图的倾向*，从而赋予你的两人[组合](https://www.amazon.com/Assemblage-Theory-Speculative-Realism-DeLanda/dp/1474413633)引导两个人走向长期正和结果的能力。这种突现的观点展示了一种卓越的理性，能够利用这样一个事实，即假设连贯的两人组合可以满足其更大的能量需求，当探索未知和潜在的敌对领域时，两个大脑、四条腿和三只手[提供了超过一个大脑、两条腿和两只手的超线性优势](https://www.youtube.com/watch?v=zyJJPuKF814)。当然，这种连贯的组合仍然更喜欢四肢完好无损地离开，但在你过桥并阅读标志的那一刻，这种选择就不存在了。正如标语所说，在生活的游戏中没有回头路； [*你已经全在*](https://www.youtube.com/watch?v=h0aA2dQqt08) *了。***

**虽然上面的寓言可能看起来是人为的，但这种看法——尽管可以理解——未能理解这个故事与支配人类新兴社会和经济景观的基本博弈论张力的同构映射。正如这个优秀的系列文章所解释的，大多数人类互动符合 Newcomb 类游戏的基本标准。换句话说，大多数社会互动都有和我们寓言一样的基本限制。**

**这些制约因素是:**

*   **自愿承担一定的短期成本以获得更大(尽管不确定)的长期利益的选择。**
*   **一个[信息不对称](https://en.wikipedia.org/wiki/Information_asymmetry)有利于建立决策环境的人。**
*   **一种机制，通过这种机制，可以知道这种信息不对称在逻辑上(虽然不是因果关系)影响决策者的选择。**

**此外，通过利用时态地图的概念，我们可以将这些标准的相关性扩展到超出最初的[博弈论问题](https://wiki.lesswrong.com/wiki/Newcomb's_problem)的边界。这是因为大多数对纽科姆悖论的解释——包括上面链接的论文系列——都假设一个人必须将关于他们未来可能行为的信息实际泄露到环境中，作为出现类似纽科姆游戏的先决条件。换句话说，通常假设某人必须获得关于你的新信息，特别是将你置于一个类似 Newcomb 的游戏中。但是，正如上面的场景所显示的，一个人作为路径依赖探索的函数而获得的任何信息不对称都可能为 Newcomb 式的悖论创造条件。只要获得信息优势的行动者——换句话说，拥有更高分辨率时间图的行动者——也拥有关于信息劣势行动者的足够知识以在行为上利用新的时空信息，就可以获得这种洞察力。这也给处于优势的行动者留下了一个选择:他们可能会利用他们的优势为自己的切身利益服务，或者为连贯的两人组合的更高层次的优势服务，将切身利益置于对该组合更大的未来潜力的尊重。**

**对于玩策略游戏的人来说可能显而易见的是，从地图探索中获得的知识可能产生相对于第三方的信息不对称，而所述知识并不特别与所讨论的人相关。简而言之，一个人可能通过获得*广泛适用的知识*而获得相对于其他人的不对称优势，而与他互动的玩家*仍然不知道这些知识。*因此*只要所学的东西在某种程度上限制了信息劣势行动者的可能性空间，单独的个性化和时间扩展的学习就足以引发 Newcomb 类游戏的出现。这个深刻的博弈论真理很可能就是为什么人类对自己行为越来越自觉的观察产生了像 [*知识就是力量*](https://en.wikipedia.org/wiki/Scientia_potentia_est) 这样的格言式编码。如果我们将权力定义为更大的博弈杠杆的位置，或者更准确地说，有效执行博弈工作的能力，我们会看到，保真度越高，一个人对时间地图的了解越广泛，他就越有能力在社会中介的 Newcomb 类游戏中把其他玩家置于有利或不利的位置。***

*这种博弈论的嵌套似乎是不可避免的，但事实是这样吗？假设我们每个人都在基本不对称和不相交的路径上穿越时空，而且我们刚刚证明了这种不对称是如何产生 Newcomb 类游戏的，那么我们必须时刻发现自己嵌套在一组不断进化的 Newcomb 类游戏中。推测起来，这些游戏拥有一定程度的对称性，与我们在早期讨论*时间共振*和*生物文化编码*时遇到的不同时空尺度的社会一致性。事实上，这种 Newcomb 式游戏的分形嵌套——在无限的时空层面上进行，并由个体代理人之间的一致性需求和代理人之间的交互产生的集体集合来参数化——可能是对我们社会景观的最佳描述。但是，虽然这些观察结果似乎加强了博弈论中筑巢的不可避免性，但它们也留下了一扇后门。这个后门虽然不能提供完全的逃脱，但确实产生了超越我们发现自己被嵌入其中的当前巢穴的程度。事实上，我们已经遇到了这个后门；这是为了更大的长期一致性而做出的勇敢的短期牺牲。*

*让我们在这里暂停一下，花一分钟时间重温一下我们之前叙述的主要含义:****个人纯粹理性的决策——缺乏关于未来状态的线索——通常会阻止集体实现最理想的结果*** *。*这是因为这种策略通常会损害信任，降低每个个体将其独特的(即*perspective*)时间地图与其他人的时间地图有意义地配对的能力，从而降低涌现的集体作为连贯集合的整体能力。相反，如果信任得以维持，足够多的个体自愿做出*勇敢的牺牲*，就有可能逃脱吸引子的极限拉力，这些吸引子控制着个体最接近行为的相干层的博弈论拓扑。以这种方式，*依赖信任的合作*揭示了它本身是一种工具，允许多智能体集合达到相对于次优博弈论奇点的逃逸速度。**

**当与其他博弈论概念的见解配对时，这种见解变得更加明显，例如[纳什均衡](https://en.wikipedia.org/wiki/Nash_equilibrium)和[帕累托最优](https://en.wikipedia.org/wiki/Pareto_efficiency)状态。对于那些不熟悉的人来说，这两个框架描述了迭代博弈的结果，其中个体的行为策略固定不变，因为玩家要么没有改变策略的直接动机，要么因为他们当前策略的改变分别以零和的方式对其他玩家产生不利影响。但是这些次优策略还有一个共同点:*它们无法发现更有能力的行为策略，这源于不合作的假设*。正如我们所有人都凭直觉理解的那样，在上文中已经明确阐述过，并且在其他创造性艺术形式中已经在神话传说故事中进行了文化编码，合作使我们能够解决一类存在主义问题，否则这些问题对于个人来说将是棘手的。诗人约翰·多恩对人类合作性相互依存的永恒思考雄辩地表达了这种情感:**

> **没有人是一座孤岛；每个人都是这块大陆的一部分，主要的一部分；如果一个土块被海水冲走，欧洲就少了，就像一个海角一样，就像你的朋友或你自己的朋友一样；任何人的死亡都是我的损失，因为我与人类息息相关。因此永远不要派人去打听丧钟为谁而鸣；它为你而鸣。**
> 
> **“没有人是一座孤岛”——约翰·多恩，1624 年**

**我们轻视和忽视人类合作能力的适应潜力，这是对我们自己的威胁。这似乎是显而易见的。然而，合作如何解决上面概述的博弈论问题，特别是关于人类今天面临的特定的 Newcomb 型问题，这有点不太明显。这就是我们对信任的新定义——生成共享时态地图的能力——变得非常有用的地方。这是因为持续的合作依赖于信任。正如我们所见，信任是在没有强制成本的情况下共享时态地图的能力。实际上，合作是一个过程，通过这个过程，我们可以最大限度地降低合并和解决时态地图之间不一致的成本，从而扩展所有各方先前拥有的地图的容量。请记住，纯粹理性的决策排除最佳结果的主要原因是因为它不能为了未来的潜力而牺牲现在的确定性。它的逻辑经常无法解释这样一个事实:从一个人直接和独特的视角看起来合理的东西，如果通过一个更广泛的时间透镜并与其他人的时间图结合起来看，往往被证明是相当不合理的*。一个理性的决策者在目前有限的信息下运作，他不能确定今天*做出一个明显理性的决定*会阻止他们在未来*获得更好的结果*。但是如果他们可以呢？***

*而事实上，*通过有效的合作，他们(和我们)可以*。从一个非常真实的意义上来说——对于那些持有简略地图的人来说——合作很像是获得了窥视未来的力量。正如我们在上面的桥梁难题中所看到的:对于那些持有高保真扩展地图的人来说，合作提供了开启最佳可能全球结果的钥匙。冒着把这个概念说得太细的风险，让我们进一步充实正在讨论的动态。考虑一种情况，其中 Alice 和 Bob 玩一个需要迭代决策的游戏。假设 Alice 的地图是 8 级——这意味着她可以在决策树中看到 8 步——而 Bob 的地图只有 3 级。作为参考，这个场景具体地举例说明了前面抽象中遇到的 [*信息不对称*](https://en.wikipedia.org/wiki/Information_asymmetry) 的概念。现在，假设 Alice 看到，根据她的扩展地图，为了在步骤 7 达到一个决策点，允许双方获得更大的结果，Bob 必须在步骤 3 做出*看似不合理的* *牺牲选择*。从一个无所不知的观察者的角度来看，Alice 在第 3 步说服 Bob*为团队*做一件事，这样双方都可以在第 7 步受益，这对双方都有利。但是鲍勃*怎么知道*爱丽丝是可以信任的呢？也许如果鲍勃同意在第 3 步接受打击，爱丽丝将能够拿走所有的奖金，留下鲍勃和他的家人挨饿。然而，如果我们给爱丽丝一个工具，让她能够保证——绝对确定——她说的是实话，并承诺她将在第 3 步和第 7 步之间进行公平的游戏，否则将她的很大一部分财富牺牲给鲍勃，会怎么样？通过这种方式，她可以与 Bob 共享她的时态地图，缓解信息不对称，并打开一种合作形式的大门，如果没有这样的技术，这种合作是不可能的。通过*利用这个合作工具*，Alice 和 Bob 获得了包含最理想结果的以前无法获得的可能性集合。*

*在非正式的人类互动领域，我们称这种分享地图的能力为*信任，*它允许跨时间的有效合作。但是很像[第二部分](https://hackernoon.com/crypto-beyond-capitalism-part-2-9309829247b2)中概述的*人际一致性*的过程，我们的直接信任能力受限于我们开始持有不同路径依赖观点的程度，因此我们必须开发技术来帮助我们努力将这种基本的人类能力具体化。我们必须建立工具来帮助我们扩展信任的能力，从而增加我们协调合作的净能力。根据*时间图共享*重新构建信任后，我们现在可以看到，除了增加价值表示的分辨率，加密经济系统还可以通过将先前不稳定的信任机制编码到可证明可信的基础层中，来扩展人类在时间上*一致合作的程度*。当然，这代表着一个几乎无法形容的巨大价值的机会。*
