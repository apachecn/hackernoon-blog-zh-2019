...
一些更聪明的人意识到，他们可以利用土地，而不是破坏动物吃草的土地，这是一个持续的自我放逐的过程。如果动物是财富，它们以土地为食，那么土地一定是比动物更丰富的财富来源。
...
现在，需要问的问题是，谁的算法？如果是苹果的，亚马逊的，ACME 的，或者任何人的，那我们还不如骑士一个暴君，骑进噩梦。这就是为什么它是一个类似于互联网或万维网的**去中心化算法是很重要的。这种算法不受任何人控制，但可以被任何人使用，形成一个网络。**
...
那么，主人会给任何人任何仍然稀缺的商品，比如汽车吗？大概不会。根据目前的数据，一个美国经销商将为大约 90%的美国家庭提供一辆汽车。因此，那些没有帮助他人创造价值的底层 10%的人将不会拥有自己的汽车。让我们现实一点，这会造成比现在更严重的贫困吗？号码

在美国，住房和食品是后稀缺品，甚至交通也是，只是汽车不是。在传统经济学中，传统上是较富裕的人有能力不拥有汽车，因为他们可以支付司机的服务费用，而拥有汽车的普通人在出城时必须租用汽车，而穷人则根本买不起任何东西。在自由主义中，搭顺风车不需要任何成本，而且这样做会让车主变得更富有，因此富人有一种通过帮助穷人来“剥削”穷人的天然动机。

在一个没有损失的经济中，*是*失去了比同龄人更快爬上社会经济阶梯的机会。每个人都想变得更富有，不是吗？更富有意味着付出更多，如果你付出的比别人多，那么也许你今晚就可以兑换酒店的顶楼套房。没有人*需要*顶层公寓，即使是有钱人也不需要，但是*他们*买得起吗？是的，按照人们的标准，只要他们帮助了足够多的人。然后他们免费得到它，作为对他们为社会所做贡献的感谢。这才公平。

自由主义并没有像马克思希望的那样消灭私有财产，但它要求拥有这种资本的人为了更大的利益而最大限度地利用这种资本，以便获利。这种激励将导致分配效率和自动化的提高，直到握手问题饱和，没有浪费的空间——资源是给予的，而不是囤积的。目前，等待交换造成了资本主义分配上的摩擦。

我们再看几个边缘案例。是什么阻止了两个人串通一气，给对方尽可能多的分数？这就是基于*单位的*、仅加性的关系货币会失败的地方。这些分数会继续膨胀这个系统，或者给他们一个暂时的不公平的优势。但在基于比率的系统中，这是不正确的，他们能做的最好的事情是改变他们的每日百分比值——他们可以在一天内多次这样做，但它只会更新排名值——没有新的交易。

那么如果他们每天都给对方 100%的日常价值呢？嗯，这将禁止他们对其他人进行排名，这将使他们在其他捐赠者和主人中不受欢迎，给他们自己一个有资格和忘恩负义的名声。或者任何过高或过低估计的每日值都可以自动进行百分比调整。例如，如果你在一天之内说食物价值是 100%，住房价值是 100%，那么两者实际上都将被计算为 50%和 50%。数学可以随时或多次重新计算，因为运算是可交换的。

最大的攻击载体是创建数以千计的假身份，但这里没有重复花费的硬币。唯一“花掉”的是你与之互动的身份，但你与他们互动得越多，你就越容易将自己与一个虚假的网络联系在一起，这让你在审计时更容易受到谴责，从而导致奢侈的主人在给予时更随意。

从技术角度来说，审计可以出奇地便宜且容易执行，尽管可能会在后台被连续索引。最糟糕的情况是，它会像在信任网上求图交集一样慢，计算时间应该不到半天。然而，一旦开始，我们目前工作的编码原型能够在全球范围内以亚秒的速度进行审计和更新，完全点对点和密码安全——无需信任中间人机构。

这个系统出奇的简单。它只需要不到十分之一的现有金融基础设施就能运行，这可能会激怒许多精英人士，因为他们没有必要隐藏过高的价格。它需要较少的思考来使用，这可能会激怒许多知识分子，因为他们不会有任何学术优势来发表意见。最后，它不需要任何人参与一个必然野蛮的系统，这可能会激怒许多有权有势的人，因为他们将没有人可以压迫，以满足他们的自尊问题。这个系统的简单性是它的优点，也是它能够工作的原因。

马后炮显而易见。如果我们想要一个能准确计算经济价值的经济系统，那么很明显，这个系统应该试图通过系统中的经济行为者来衡量价值。资本主义和社会主义试图通过债务来代表这一变量，但这从根本上意味着价值不能被重新创造——它必须“来自”或平衡于其他地方。这种假设是因为这些系统的基本要素无法对其建模，它们采用零总和交换、单位货币和项目会计，而不是网络中的连接。

# 跨越财富时代:从这里到那里

在自由主义中，价值可以来自其他地方，但它也可以模拟和解释以前的系统无法想象的后稀缺商品，如数字信息。因此，它能够包容资本主义和社会主义，就像爱因斯坦物理学对牛顿模型所做的那样，同时还能驱动新的行为。这是系统的一个关键属性，因为它使系统在进化上可行。

后稀缺被定义为数量大于可供使用的人类数量的任何物品。没有什么能阻止人们为稀缺商品买单，只是他们觉得这不合理。但是这种支付并不减损或突然使该物品变得不可获得——它并不改变该物品的性质或经济属性。

这允许人们在同一“交易”中接受两种形式的货币，而不会影响市场经济。这对于比特币来说是不可能的，因为比特币和美元都很稀缺，所以人们不会想要双重支付。但人们已经习惯了为他们的优步司机付费和评级。你可以得到现金和每日百分比价值。

拥有这样的评级本身就很有价值，因为它们可以用来将你与各种社区中其他慷慨的主人相匹配。他们有一个自然的动机为你提供补贴或免费的服务，如交通、住房、数字商品或其他东西，以便得到其他知名主持人的更高评价。这加强了你的网络，让你发现新的关系，释放以前未开发的价值，同时对更大的交易人群共享服务越来越有竞争力。

一个简单的博弈论规则是，在两个人已经拥有该系统的情况下，他们将相应地对彼此进行评级，以获得网络效应，而不管是否使用现金。在任何人被允许使用评级系统的情况下，为了保护他们的现金，他们都会这样做。在只接受现金而没有竞争的地方，人们可能会试图说服店主加入，或者回到现金。但是在有竞争的商店或服务的地方，人们会被激励去选择一个接受评级的，或者保存现金或者获得网络优势。

总之，这意味着新的经济模式将最终超越旧的，成为主导模式。它可以在以不冲突的方式与旧模型集成的同时做到这一点，但仍然可以增加任何交互的总附加值，即使它尚未被视为一种货币。

最后，由于货币只是附加的，网络效应只会增加，所以人们有一种自然的动机尽早加入，因为他们的财富平均增长会比其他人多得多，这增加了他们获得奢侈品的几率——他们的努力没有成本或损失。

# 结论

对自由主义最大的威慑可能是解释自由主义。资本主义和社会主义嵌入了它们宿主的大脑，描述任何其他或竞争系统都会在它们的受害者中引发一波部落对抗。再多的词语或更好的词语安排也无法说服任何人。纯粹是那些已经足够开放的人可能理解这个系统的含义，不是因为在这里读到的任何东西，而仅仅是因为他们已经在他们的思维中得到锻炼。

思考自由主义也很可能是徒劳的——所以从这个意义上说，作者写这个是浪费时间。唯一有成效的方向是实现它，让人们把它当作游戏或玩具来使用。不能认真对待它，因为这将暴露它与现状有多么不同。但是当作为一种选择时，人们会选择其他的。这将是衡量其成功和确定其经济效益的最佳方式。

如果你喜欢这篇文章，请在 [Twitter](https://twitter.com/marknadal) 上关注我，并查看[我们迈向](https://github.com/amark/gun)实施时代的工作。ERA 是本文描述的经济资源分配算法，带来自由主义。