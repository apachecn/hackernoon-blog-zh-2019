...
因此，我们失去了允许客户在一次交易中交易 10 或 20 或 30 个比特币的能力，但我们确实获得了允许菲亚特交易的能力。在这种情况发生几个月后，我们发现我们需要一个订单簿，由于没有合适的流动性提供商，我们可能需要开发自己的解决方案。这就是我们如何想出制作 DEX 的主意，就像一个链外杂交 DEX。具有离线匹配引擎的分散式交换机。
